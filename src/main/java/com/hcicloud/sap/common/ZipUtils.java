...
//            System.out.println("正在写文件 - " + srcFile.getAbsolutePath() + "  entryName=" + entryName);
    ...
    public static void main(String[] args){
        try {
            writeByApacheZipOutputStream("D:\\home\\mhn\\voiceftp\\fsr\\2017\\09\\26\\unzip\\20170926_fsr_1_0", "D:\\home\\mhn\\voiceftp\\fsr\\2017\\09\\26\\zip\\20170925_fsr_1_0" + ".zip", "");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
